...
import uk.gov.hmcts.reform.opal.entity.BusinessUnitUserEntity_;
...
public class BusinessUnitUserSpecs extends EntitySpecs<BusinessUnitUserEntity> {
    ...
    public static Predicate equalsBusinessUnitUserIdPredicate(From<?, BusinessUnitUserEntity> from,
        ...
        return likeWildcardPredicate(from.get(BusinessUnitUserEntity_.businessUnitUserId), builder,
        businessUnitUserId);
    }
