...
public class SynchroniseBusinessUnitUsersService {
    ...
    public void synchroniseBusinessUnitsUsers(UserEntity user, List<LegacyBusinessUnitUserId> legacyBusinessUnitUsers) {
        if (legacyBusinessUnitUsers == null) {
            ...
            throw new SynchronisePermissionsException("Legacy business unit user payload is missing");
        }
        ...
        for (LegacyBusinessUnitUserId legacyBusinessUnitUser : legacyBusinessUnitUsers) {
            if (legacyBusinessUnitUser == null) {
                log.error("Legacy business unit user payload contains null entry for user {}", user.getUserId());
                throw new SynchronisePermissionsException("Legacy business unit user entry is missing");
            }
    ...
    private Short parseBusinessUnitId(String legacyBusinessUnitId) {
        try {
            ...
            throw new SynchronisePermissionsException("Invalid business unit id: " + legacyBusinessUnitId, e);
        }
    }
