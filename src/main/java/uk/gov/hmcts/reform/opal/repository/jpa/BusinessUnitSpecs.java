...
import uk.gov.hmcts.reform.opal.dto.search.BusinessUnitSearchDto;
import uk.gov.hmcts.reform.opal.entity.BusinessUnitEntity;
import uk.gov.hmcts.reform.opal.entity.BusinessUnitEntity_;
...
public class BusinessUnitSpecs extends EntitySpecs<BusinessUnitEntity> {
    ...
    public static Predicate equalsAnyBusinessUnitIdPredicate(
        From<?, BusinessUnitEntity> from, Collection<Short> businessUnitId) {
    ...
    public static Predicate likeBusinessUnitTypePredicate(
        ...
        return likeWildcardPredicate(from.get(BusinessUnitEntity_.businessUnitType).as(String.class), builder,
                                     businessUnitType);
    }
