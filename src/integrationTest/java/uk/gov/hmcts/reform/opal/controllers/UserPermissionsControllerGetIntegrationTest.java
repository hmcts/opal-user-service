...
@DisplayName("UserPermissionsController 'Get User State' Integration Tests with Security")
class UserPermissionsControllerGetIntegrationTest extends AbstractIntegrationTest {
    ...
    void getUserState_whenUserHasPermissions_returns200AndCorrectPayload(Boolean newLogin) throws Exception {
        ...
        Optional.ofNullable(newLogin).ifPresent(value -> builder.header("x-new-login", value));
