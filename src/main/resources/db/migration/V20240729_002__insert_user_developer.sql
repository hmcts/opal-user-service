...
* ----------    -------     --------    ------------------------------------------------------------------------------------------------------------------------------------------------------------------
* 29/07/2024    R. Dodd     1.0         PO-537 As an extension of the work to restrict BE functionality to users with the correct roles and permission, create a 'developer' user.
*
**/
INSERT INTO users
(
