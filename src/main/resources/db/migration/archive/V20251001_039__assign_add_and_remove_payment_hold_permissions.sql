...
* CGI OPAL Program
*
* MODULE      : assign_add_and_remove_payment_hold_permissions.sql
*
* DESCRIPTION : Assign new permission for Add and Remove payment hold to business unit user accounts
*
* VERSION HISTORY:
*
* Date          Author      Version     Nature of Change
* ----------    --------    --------    ----------------------------------------------------------------------------------------------------------------------------
* 22/09/2025    P Brumby    1.0         PO-1928 - Users - Assign new permission for Add and Remove payment hold to the appropriate business units and user accounts.
*
**/
DO $$
DECLARE
...
BEGIN
    ...
    WHERE function_name = 'Add and Remove payment hold';
