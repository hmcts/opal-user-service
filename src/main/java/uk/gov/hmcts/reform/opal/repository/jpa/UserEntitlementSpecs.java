...
import uk.gov.hmcts.reform.opal.entity.UserEntitlementEntity_;

import static uk.gov.hmcts.reform.opal.repository.jpa.ApplicationFunctionSpecs.likeFunctionNamePredicate;
import static uk.gov.hmcts.reform.opal.repository.jpa.BusinessUnitSpecs.equalsBusinessUnitIdPredicate;
import static uk.gov.hmcts.reform.opal.repository.jpa.BusinessUnitSpecs.equalsParentBusinessUnitIdPredicate;
import static uk.gov.hmcts.reform.opal.repository.jpa.BusinessUnitSpecs.likeBusinessUnitNamePredicate;
import static uk.gov.hmcts.reform.opal.repository.jpa.BusinessUnitSpecs.likeBusinessUnitTypePredicate;
import static uk.gov.hmcts.reform.opal.repository.jpa.BusinessUnitUserSpecs.equalsBusinessUnitUserIdPredicate;
import static uk.gov.hmcts.reform.opal.repository.jpa.BusinessUnitUserSpecs.joinBusinessUnit;
import static uk.gov.hmcts.reform.opal.repository.jpa.BusinessUnitUserSpecs.joinUser;
import static uk.gov.hmcts.reform.opal.repository.jpa.UserSpecs.equalsUserIdPredicate;
import static uk.gov.hmcts.reform.opal.repository.jpa.UserSpecs.likeUserDescriptionPredicate;
import static uk.gov.hmcts.reform.opal.repository.jpa.UserSpecs.likeUsernamePredicate;
...
public class UserEntitlementSpecs extends EntitySpecs<UserEntitlementEntity> {
    ...
    public static Specification<UserEntitlementEntity> likeUserId(Long userId) {
        return (root, query, builder) ->
        equalsUserIdPredicate(joinUser(joinBusinessUnitUser(root)), builder, userId);
    }

    public static Specification<UserEntitlementEntity> likeUsername(String username) {
        return (root, query, builder) ->
        likeUsernamePredicate(joinUser(joinBusinessUnitUser(root)), builder, username);
    }
