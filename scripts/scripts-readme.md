...
Builds the Opal docker stack from the `/Users/{currentUser}/Opal` workspace. if this is not where you have your you will need to update the `BASE_DIR` in the script to match your workspace.
