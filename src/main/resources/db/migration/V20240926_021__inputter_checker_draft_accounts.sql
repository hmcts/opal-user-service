...
*
* DESCRIPTION : In the Opal User Service - Introduce the new Application Function (aka permission) named: Check and Validate Draft Accounrts. Update the existing Manual Account Creation permission to be called Create and Manage Draft Accounts.
...
* ----------    -------     --------    ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
* 26/09/2024    A Dennis    1.0         PO-800 In the Opal User Service - Introduce the new Application Function (aka permission) named: Check and Validate Draft Accounrts. Update the existing Manual Account Creation permission to be called Create and Manage Draft Accounts. Then assign these permissions to specified users. 
*                                       Introduce the 2 new templates and their template mappings: Create and Manage Draft Accounts - Authorised Powers    and also  Check and Validate Draft Accounts - Authorised Powers
*
**/
