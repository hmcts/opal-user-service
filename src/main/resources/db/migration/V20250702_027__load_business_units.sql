...
*
* DESCRIPTION : Load business_units table with reference data including account_number_suffix values in user service.
*
* VERSION HISTORY:
*
* Date          Author      Version     Nature of Change
* ----------    -------     --------    -----------------------------------------------------------------------------------------------------------------------------------
* 02/07/2025    C Cho       1.0         PO-1795 Load business_units table in user service with reference data including account_number_suffix values.
*
**/
...
INSERT INTO business_units (business_unit_id,business_unit_name,business_unit_type,business_unit_code,account_number_prefix,account_number_suffix,parent_business_unit_id,opal_domain,welsh_language)
VALUES (111,'Houghton','Accounting Division','0102',NULL,'MA',1007,'RM',FALSE);
INSERT INTO business_units (business_unit_id,business_unit_name,business_unit_type,business_unit_code,account_number_prefix,account_number_suffix,parent_business_unit_id,opal_domain,welsh_language)
...
INSERT INTO business_units (business_unit_id,business_unit_name,business_unit_type,business_unit_code,account_number_prefix,account_number_suffix,parent_business_unit_id,opal_domain,welsh_language)
VALUES (77,'Lambeth and Southwark','Accounting Division','0046',NULL,'CG',1001,'Fines',FALSE);
INSERT INTO business_units (business_unit_id,business_unit_name,business_unit_type,business_unit_code,account_number_prefix,account_number_suffix,parent_business_unit_id,opal_domain,welsh_language)
VALUES (73,'H&F, K&C (West London)','Accounting Division','0042',NULL,'WL',1001,'Fines',FALSE);
INSERT INTO business_units (business_unit_id,business_unit_name,business_unit_type,business_unit_code,account_number_prefix,account_number_suffix,parent_business_unit_id,opal_domain,welsh_language)
VALUES (67,'CAO - Inner London Maintenance (Wells Street)','Accounting Division','0036',NULL,'MA',1001,'RM',FALSE);
INSERT INTO business_units (business_unit_id,business_unit_name,business_unit_type,business_unit_code,account_number_prefix,account_number_suffix,parent_business_unit_id,opal_domain,welsh_language)
...
INSERT INTO business_units (business_unit_id,business_unit_name,business_unit_type,business_unit_code,account_number_prefix,account_number_suffix,parent_business_unit_id,opal_domain,welsh_language)
VALUES (44,'Northants Maintenance','Accounting Division','0097',NULL,'MA',1022,'RM',FALSE);
INSERT INTO business_units (business_unit_id,business_unit_name,business_unit_type,business_unit_code,account_number_prefix,account_number_suffix,parent_business_unit_id,opal_domain,welsh_language)
...
INSERT INTO business_units (business_unit_id,business_unit_name,business_unit_type,business_unit_code,account_number_prefix,account_number_suffix,parent_business_unit_id,opal_domain,welsh_language)
VALUES (26,'North and East Hertfordshire','Accounting Division','0069',NULL,'HE',1027,'Fines',FALSE);
INSERT INTO business_units (business_unit_id,business_unit_name,business_unit_type,business_unit_code,account_number_prefix,account_number_suffix,parent_business_unit_id,opal_domain,welsh_language)
...
UPDATE business_units SET account_number_suffix = 'MA' WHERE business_unit_id = 44;
...
UPDATE business_units SET account_number_suffix = 'MA' WHERE business_unit_id = 67;
...
UPDATE business_units SET account_number_suffix = 'MA' WHERE business_unit_id = 111;
