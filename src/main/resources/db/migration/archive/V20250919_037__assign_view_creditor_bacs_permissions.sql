...
* CGI OPAL Program
*
* MODULE      : assign_view_creditor_bacs_permissions.sql
*
* DESCRIPTION : Assign new permission for View Creditor BACS to business unit user accounts
*
* VERSION HISTORY:
*
* Date          Author      Version     Nature of Change
* ----------    --------    --------    ------------------------------------------------------------------------------------------------------------------
* 16/09/2025    P Brumby    1.0         PO-2003 - User - Assign new permission for View Creditor BACS to the appropriate business units and user accounts.
*
**/
DO $$
DECLARE
...
BEGIN
    ...
    -- Get the application_function_id from APPLICATION_FUNCTION for the View Creditor BACS permission using STRICT
    SELECT application_function_id 
    INTO STRICT v_app_fn_id 
    FROM application_functions 
    WHERE function_name = 'View Creditor BACS';
    
    --Insert new records, for the system test users, into USER_ENTITLEMENTS for the new APPLICATION_FUNCTION record for View Creditor BACS permission
    WITH max_ue AS (
