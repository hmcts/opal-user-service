...
* ----------    -------     --------    ---------------------------------------------------------------------------------------------------------------------------------------------------------------
* 05/11/2024    A Dennis    1.0         PO-960 In the BUSINESS_UNIT_USERS table correct the business_unit_ids for user opal-test-9@HMCTS.NET (500000008) so that they match their business_unit_user_id
*
**/
